...
router.route("/").get((req, res) => {
  const query =
    "select distinct [dbo].[Port_Door_Indicator].[id] as value, CONCAT([dbo].[Port_Door_Indicator].[Customer],'-', [dbo].[Port_Door_Indicator].[Description]) as label from [dbo].[Port_Door_Indicator] order by value";
